...
toolbarUI <- function(id) {
  ...
  div(class = "toolbar",
      div(class = "tool-group",
          h4("Basic Tools"),
          div(
            div(class = "tool-tile", `data-tool` = "number", title = "Place Numbers", "●"),
      ...
      # Add 'players-group' class to this tool group for highlighting
      div(class = "tool-group players-group",
          h4("Players"),
          
          div(style = "margin-top: 10px;",
              div(
                div(class = "number-tile", `data-number` = "1", "1"),
                div(class = "number-tile", `data-number` = "2", "2"),
                div(class = "number-tile", `data-number` = "3", "3"),
                div(class = "number-tile", `data-number` = "4", "4"),
                div(class = "number-tile", `data-number` = "5", "5")
              )
          )
      ),
...
canvasAreaUI <- function(id) {
  ...
  div(class = "canvas-area",
      ...
      div(class = "status-bar",
          span(id = "tool-status", "Ready - Select a tool and click on the court"),
          span(id = "coords", "")
      )
  )
}